...
const identity1 = new identity('Hendriansyah', 'Hendri', 'Basket');
...
class Person {
  ...
  greeting() {
    return 'namaku ' + this.Nama + ' aku kelas ' + this.Kelas + ' umurku ' + this.Umur;
  }
}

const hendrik = new Person('hendri', 12, 17);
console.log(hendrik.greeting());
